...
const about = ( props ) => {
    ...
    return (
        <div id="aboutContainer" className={props.className}>
            <div className="control" id="topArrow" onClick={() => props.scroll()} >
            ...
            <div id="top">
                <h2>About</h2>
                <h3>
                    Passionate, creative developer and designer.
                </h3>
                <h3>
                    My favorite language is javascript and I use the adobe creative suite.
                </h3>
                <br />
            </div>
            <div id="bottom">
